...
1. **Source text ready**: `data/source-texts/bhagavad-gita-sanskrit.txt`
2. **Run the parser**: `python scripts/parse_gita.py data/source-texts/bhagavad-gita-sanskrit.txt > data/verses/bhagavad-gita.yaml`
...
**Current Source:**
- File: `data/source-texts/bhagavad-gita-sanskrit.txt`
